  ...
  return (
    <tr className='border-y border-gray-300'>
        ...
        <td className='px-2 py-4 flex text-xs gap-3'>
            <button onClick={togglePulish} className='border px-2 py-0.5 mt-1 rounded cursor-pointer'>{blog.isPublished ? 'Unpublished' : 'Published'}</button>
